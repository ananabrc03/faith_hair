...
- Les rendez-vous confirmes ET en attente bloquent le creneau (pas de chevauchement). Un rdv annule ou mis en corbeille libere le creneau.
- Disponibilites gerees par semaine (perspective 4 semaines) plus un gabarit d'horaires par defaut. Reglages accessibles via l'icone cle a molette.
