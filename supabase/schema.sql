...
create table prestations (
  ...
  duree_base_min int not null default 60,   -- borne basse (taille gros)
  duree_max_min int,                        -- borne haute (taille petit)
...
create table reglages (
  ...
  valeur_texte text            -- pour les reglages de type texte (page d'intro)
);
...
create table reservations (
  ...
  options jsonb not null default '[]'::jsonb,   -- options choisies [{cle,nom,prix,min}]
